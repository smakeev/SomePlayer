...
public protocol Streaming: class {
    ...
    /// An `AVAudioplayerEngineNode` used to schedule the LPCM audio buffers
    var playerEngineNode: AVAudioPlayerNode { get }
    
    /// An `AVAudioFrameCount` representing the number of frames that should be read from the `reader` and scheduled into the `playerEngineNode`. Default value is 8192
